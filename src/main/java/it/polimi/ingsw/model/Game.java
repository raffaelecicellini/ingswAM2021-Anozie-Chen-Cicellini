...
public class Game {
    ...
    public void produce(String player, Message info) throws InvalidActionException {
        if (currentPlayer.getName().equals(player) && !doneMandatory) {
            ...
            doneMandatory = true;
        } else if (currentPlayer.getName().equals(player) && doneMandatory)
            throw new InvalidActionException("You have already done a mandatory action!");
    ...
    public void activateLeader(String player, int pos) throws InvalidActionException {
        if (currentPlayer.getName().equals(player) && doneLeader < 2) {
            ...
            doneLeader++;
        } else if (currentPlayer.getName().equals(player) && doneLeader == 2)
            throw new InvalidActionException("You can't activate another leader");
        else throw new InvalidActionException("It is not your turn!");
        //notify changes to player
    ...
    public void discardLeader(String player, int pos) throws InvalidActionException {
        if (currentPlayer.getName().equals(player) && doneLeader < 2) {
            ...
            throw new InvalidActionException("You can't discard another leader");
        else throw new InvalidActionException("It is not your turn!");
        //notify changes to player
                ...
                if (row >= 1 && row <= 3) {
                    ...
                    for (Player p : players) {
                        if (!p.equals(currentPlayer))
                            p.getPersonalBoard().setPosition(p.getPersonalBoard().getPosition() + discarded);
                    }
                    doneMandatory = true;
