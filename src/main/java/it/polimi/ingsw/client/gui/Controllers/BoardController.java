...
public class BoardController extends GUIController {
    private GUI gui;
    @FXML
    private Label blue_qty, yellow_qty, grey_qty, purple_qty;
    @FXML
    private ImageView small, mid1, mid2, big1, big2, big3;
    @FXML
    private ImageView leader_res00, leader_res01, leader_res10, leader_res11;
    @FXML
    private ImageView dev0, dev1, dev2;
    @FXML
    private ImageView leader0, leader1;
    @FXML
    private Label sp_leader0, sp_leader1;
    @FXML
    private Label slot0, slot1, slot2;
    @FXML
    ...
    @FXML
    private Button show, buy, produce, market, activate, discard, swap, endturn;
